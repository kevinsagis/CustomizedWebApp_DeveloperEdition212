...
function(lang, array, html, has, config, ioQuery, query, nlt, Deferred, all, on, json, cookie,
  ...
  Extent, geometryEngine, Multipoint, Polyline, Polygon, webMercatorUtils, GeometryService, ProjectParameters,
    FeatureSet, PictureMarkerSymbol, esriUrlUtils, esriRequest, Moveable, domClass, EsriQuery, QueryTask, graphicsUtils, IdentityManager,   // add Moveable, domClass,  kevin m
  ...
  //};
    ...
    // kevin m add moving popups  https://community.esri.com/thread/161401?commentID=596061#comment-596061
