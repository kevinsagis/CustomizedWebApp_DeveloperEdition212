    ...
    postCreate:function(){
      ...
      if(this.showTitle){
        ...
        if(this.title){
         ...
         //   this.titleTextBox.set('value', 'Click and drag to move this info box'); // kevin m mod
        }
      }else{
        ...
        myFunction();
       // #map_root > div.esriPopup.esriPopupVisible.dojoMoveItem > div.esriPopupWrapper > div: nth - child(1) > div > div.title
