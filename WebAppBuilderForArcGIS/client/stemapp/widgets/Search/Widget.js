          ...
          .then(lang.hitch(this, function(layerInfosObj) {
            ...
            when(utils.getConfigInfo(this.config)).then(lang.hitch(this, function(config) {
              ...
              this.searchDijit = new Search({
                  ...
                  ///
                  minCharacters: 7,   /// kevin m override to speed up performance to stop it from requesting data from Locator services until at least 7 characters entered
                  ///
...
//                ////  kevin m timeout to ensure it does not leave out Locator results!!!!!  When user hits return instead of waiting for the Suggestions to come back from all locators, particularly the Address locator
//                this.own(
//                    //on(this.searchDijit, 'search-results', lang.hitch(this, '_onSearchResults')) //Original line of code
//                    on(this.searchDijit, 'search-results', lang.hitch(this, '_searchResultsTimeout')) //will call the timeout function instead of the _onSearchResults
//                );
...
//                this.own(
//                    //on(this.searchDijit, 'select-result', lang.hitch(this, '_onSelectResult')) //Original line of code
//                    on(this.searchDijit, 'select-result', lang.hitch(this, '_selectResultTimeout')) //will call the timeout function instead of the _onSelectResult
//                );
...
//        ///// kevin m 
//        _searchResultsTimeout: function (evt) {
//            setTimeout(lang.hitch(this, function () {
//                this._onSearchResults(evt);
//            }), 5000); //waiting 5 seconds before calling _onSearchResults
//        },

//        //// adding timeout to wait before the result is selected and zoomed to
//        /************************************************************************************************
//        * Note, select result must wait longer than the search result timeout, otherwise it fails
//        * Reason why is that the selectresult is dependent on the outputs search results returned before 
//        * selecting and zooming into it.
//        ***********************************************************************************************/

//        _selectResultTimeout: function (e) {
//            setTimeout(lang.hitch(this, function () {
//                this._onSelectResult(e);
//            }), 6000); //waiting 6 seconds
//        },
/////// kevin m
