    ...
    function(declare, _WidgetsInTemplateMixin, BaseWidget, GraphicsLayer, Edit, Graphic, Extent, Point,
        ...
        return declare([BaseWidget, _WidgetsInTemplateMixin], {
            ...
            postCreate: function() {
                ...
                this.textSymChooser.textFontSize.value = "20"; // kevin m override default 12
				this.textSymChooser.textFontSize.textbox.value = "20";  // kevin m override default 12
                this.textSymChooser.textColor.color.b = "255"      // kevin m add this line for legibility -- some time later replace Font namespace with textSymbol which supports haloColor Property
                this.textSymChooser.textColor.color.r = "225"      // kevin m add this line for legibility -- some time later replace Font namespace with textSymbol which supports haloColor Property

                this.lineSymChooser.lineColor.color.b = "245"      // kevin m add this line for legibility -- some time later replace Font namespace with textSymbol which supports haloColor Property
                                this.lineSymChooser.lineColor.color.r = "171"      // kevin m add this line for legibility -- some time later replace Font namespace with textSymbol which supports haloColor Property
                this.lineSymChooser.lineColor.color.g = "0"      // kevin m add this line for legibility -- some time later replace Font namespace with textSymbol which supports haloColor Property
            ...
            _addSegmentMeasure: function(pt, angle, length) {
                var a = Font.STYLE_NORMAL;  //  not STYLE_ITALIC kevin m  note this is an Esri JS API property
