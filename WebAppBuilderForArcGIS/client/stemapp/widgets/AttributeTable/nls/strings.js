define({
  root: ({
    ...
    exportMessage: "Download data to table file CSV?", //kevin m
        exportFiles: "Download data to a table file", // kevin m
        exportSelected: "Download selected data rows to a table file", // kevin m
        exportAll: "Download ALL data to a table file", // kevin m
        options: "Download or Filter by Query", // kevin m
    zoomto: "Zoom to",
    highlight: "Highlight graphics",
        selectAll: "Select rows in all pages",// kevin m
        selectPage: "Select rows in current page",// kevin m
    clearSelection: "Clear selection",
    filter: "Filter by Query",  // kevin m
    ...
    noFilterTip: "Without filter expressions defined, this query task will list all features in the specified data source.",
        filterByExtent: "ONLY show features inside the view on screen (on/off)", // kevin m
    ...
    noTablesAvailable: "No tables available to display.",
        checkConfigutationToSelectLayers: "No map layers added. Go to the Layer List and click 'View in Attribute Table' for a layer.  Or click the '...' on a feature's Popup on the map, and then click 'View in Attribute Table'.  For details, see the Help manual, page 16 (Section 3.2: Layer List and Attribute Table).", //kevin m
