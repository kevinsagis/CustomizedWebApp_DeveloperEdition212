...
define(['dojo/_base/declare',
  ...
  /* global jimuConfig*/
  var MIN_MARGIN = 18, ICON_SIZE = 40, ICON_IMG_SIZE = 22, BUTTON_SIZE = 60,    // default margin is 8 and IMGSIZE is 20  kevin m mod
  ...
  var clazz = declare([BaseWidget, PoolControllerMixin], {
    ...
    switchToNormalStyle: function(){
      ...
      mapBox = domGeometry.getContentBox(jimuConfig.mapId);
      widgetWidth = Math.floor(mapBox.w / 1.3);   // kevin m  modified from default of 2 to make it wider to fit all widgets in 
