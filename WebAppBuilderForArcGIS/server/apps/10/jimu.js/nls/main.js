define({
  root: ({
    ...
    drawBox: {
      ...
      triangle: "Triangle",
      extent: "Rectangle",  // kevin m was extent
      circle: "Circle",
      ellipse: "Ellipse",
      polygon: "Polygon",
    ...
    exportTo: {
      exportTo: "Export",
        toCSV: "Download as a table (Excel CSV file)",  // kevin m
        toFeatureCollection: "Download as feature collection", // kevin m
        toGeoJSON: "Download as GeoJSON (GIS)" // kevin m
    },
    appState: {
        title: "....... Reload the map where I left off ....... ",
        restoreMap: "   CLICK HERE to reload previous map location !"
    },     // kevin m modified the title and restoreMap text from default gibberish
    featureActions: {
      ...
      ClearSelection: "Clear selection",
        ExportToCSV: "Download as a table (Excel CSV file)",  // kevin m
      ShowSelectedFeature: "Show selected features",
      ExportToFeatureCollection: "Download as feature collection",
        ExportToGeoJSON: "Download as GeoJSON (GIS)", // kevin m
    ...
    shareLink: {
      ...
      currentMapExtent: "Current map view",  // kevin m was extent
      ...
      shareMapUrlExtent: "Share current map view",  // kevin m was extent
