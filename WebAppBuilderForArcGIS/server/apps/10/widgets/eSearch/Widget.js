    ...
    return declare([BaseWidget, _WidgetsInTemplateMixin], {
      ...
      onReceiveData: function(name, widgetId, data) {
        if(data.message && data.message === "Deactivate_DrawTool"){
          ...
          //  alert('onreceivedatadeactive')
            this.map.setMapCursor("default");  // kevin m restore map cursor 
        }
      },
      ...
      onOpen: function () {
        ...
        if (this.selectionGL) {
          ...
          panel.position.width = 425;
          panel.position.height = 410;
          panel.setPosition(panel.position);
          panel.panelManager.normalizePanel(panel);
           // domStyle.set(widgets_eSearch_Widget_55_panel, "left", "95px");
...
///
      ...
      _resetDrawBox: function () {
        this.drawBox.deactivate();
          this.drawBox.clear();
          //alert('drawend')
          this.map.setMapCursor("default");  // kevin m reset cursor 
...
//            console.info("spatial layer index: " + this.spatialLayerIndex);
      ...
      _initTabContainer: function () {
        ...
        if(this.autoactivatedtool && initView === "graphical" && this.shapeTab){
            ...
            this.map.setMapCursor("url(widgets/eSearch/images/images/cursor_parcel1.cur),auto");  // kevin m cursor robert modification
        ...
        this.own(on(this.tabContainer, "tabChanged", lang.hitch(this, function (title) {
          ...
          if(title === this.nls.selectFeatures) {
            if(this.autoactivatedtool){
                this.drawBox.activate(this.autoactivatedtool.toUpperCase());
              // kevin m cursor robert modification
                this.map.setMapCursor("url(widgets/eSearch/images/cursor_parcel1.cur),auto");
...
//        console.info(fldName, layerIndex, relateId);
      ...
      _initDrawBox: function () {
        this.keepgraphicalsearchenabled = this.config.graphicalsearchoptions.keepgraphicalsearchenabled || false;
          aspect.before(this.drawBox, "_activate", lang.hitch(this, function () {
              this.map.setMapCursor("url(widgets/eSearch/images/cursor_parcel1.cur),auto");  // kevin m cursor robert modification
      ...
      isSelTabVisible: function () {
        ...
        case this.nls.selectByAttribute:
                this.map.setMapCursor("default");  // kevin m restore map cursor  //kevin m 
...
//modify the currentFeatures with the new results
      ...
      _selectResultItem: function (index, item) {
        ...
        //if(lyrHasPopupDisabled || (this.config.hasOwnProperty("disablePopups") && this.config.disablePopups == true)){
