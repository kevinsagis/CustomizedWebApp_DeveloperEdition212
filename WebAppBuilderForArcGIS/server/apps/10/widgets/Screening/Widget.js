  ...
  return declare([BaseWidget, _WidgetsInTemplateMixin], {
    ...
    onOpen: function () {
      ...
      if (this._highlightGraphicsLayer) {
        ...
        //  //kevin m override to open Draw tab at start //////
        //         Show draw tool panel
        //        this._showActiveToolPanel("drawTool");
        //  /////
        //why don't these work???!!!   only on SECOND opening forward not instantiation even though it SHOULD work. 
        //_onDrawToolsButtonClick();
