...
define([
  ...
  function(declare, lang, array, html, on, Deferred, _WidgetsInTemplateMixin, dojoPopup,
      ...
      DataSourceManager, SourceLauncher, ExtraSourceLauncher, ChartSetting, IGUtils, WidgetManager, ready, utils) {
      ...
      return declare([BaseWidget, _WidgetsInTemplateMixin], {
          ...
          onOpen: function () {
              ...
              //// kevin m mod frmo robert s to open esearch and switch to Graphical tab
                var widgetCtlr = WidgetManager.getInstance().getWidgetsByName("AnchorBarController")[0];
              if (widgetCtlr.getOpenedIds().indexOf(this.appConfig.widgetPool.widgets[0].id) === -1) {
                  widgetCtlr.setOpenedIds([this.appConfig.widgetPool.widgets[0].id]);
              }
              setTimeout(lang.hitch(this, function () {
                 
                  var es = WidgetManager.getInstance().getWidgetById(this.appConfig.widgetPool.widgets[0].id);
                  es.tabContainer.selectTab(es.nls.selectFeatures);   //  instead of es.nls.selectByAttribute
              }), 1300);
           //////
          ////  kevin m
