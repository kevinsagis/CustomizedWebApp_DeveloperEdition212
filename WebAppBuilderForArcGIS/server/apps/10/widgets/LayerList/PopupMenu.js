...
define([
  ...
  'dojo/query',
    ...
    "esri/request",// kevin m

    "dijit/Dialog",  // kevin m
    "dojo/dom", // kevin m
  ...
  './PopupMenuInfo'
        ...
        esriRequest, Dialog, dom,  // kevin m
        keys, focusUtil, Deferred, DropMenu, jimuUtils,
                ...
                function requestSucceeded(response, io) {
                    ...
                    if (response.hasOwnProperty("description")) {
                        if (response.description.length > 0) {
                            ...
                            ///  REST Link - may want to disable
                            + '<br><br><b>GIS Details:</b><br><br> ' + '<a href=' + layerUrl + ' target="_blank"' + '>' + 'REST Link</a> ';
                            //   REST Link
